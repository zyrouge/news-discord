...
class Client {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            const EventLoadLog = Utils_1.Logger.Ora({
                text: `Loading Events from ${Utils_1.Logger.chalk.underline(this.options.events)}`,
                prefixText: Utils_1.Logger.time
            }).start();
            ...
            const CommandLoadLog = Utils_1.Logger.Ora({
                text: `Loading Commands from ${Utils_1.Logger.chalk.underline(this.options.events)}`,
                prefixText: Utils_1.Logger.time
            }).start();
