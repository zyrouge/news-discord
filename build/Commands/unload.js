...
exports.execute = (News, { message, args }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!cmd)
            return message.channel.createMessage(`${NewsCore.Utils.Emojis.cross} \`${args[0]}\` command not found.`);
        News.commander.unload(cmd.config.name);
        message.channel.createMessage(`${NewsCore.Utils.Emojis.tick} Unloaded \`${cmd.config.name}\` command.`);
    }
    catch (err) {
